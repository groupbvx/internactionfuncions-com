...
export function useScrollDepth(
    ...
    useEffect(() => {
        ...
        const handleScroll = () => {
            ...
            // Se o usuário rolou mais do que o threshold, disparar evento
            if (scrollPercentage >= threshold) {
                hasTrackedRef.current = true;
                
                // Capturar evento via AnalyticsService
                AnalyticsService.captureArticleScrollDeep(articleId, articleSlug, scrollPercentage);
                
                // Remover listener após capturar
        ...
        // Throttle para performance (executar no máximo a cada 100ms)
        let lastCall = 0;
        ...
        // Verificar scroll inicial (caso a página já esteja scrollada)
        handleScroll();
